            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 text-lg mb-2">{roleOption.name}</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {SPORTS_CATEGORIES.map((sport, index) => (
          <motion.button
            ...
            className={`p-6 border-2 rounded-xl text-sm font-medium transition-all duration-300 ${
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white">
            <div className="text-center mb-8">
              ...
              <p className="text-blue-100">Let's set up your account to get the best experience</p>
            </div>
            ...
            >
              ...
              {currentStep < 3 ? (
                ...
                <motion.button
                  ...
                  className="px-8 py-3 bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-xl font-medium hover:from-green-600 hover:to-blue-600 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <span className="flex items-center space-x-2">
                    {isLoading ? (
                      <>
