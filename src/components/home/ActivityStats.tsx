    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
          <div className="text-3xl font-bold text-blue-600 mb-1 truncate">{formatNumber(stats.posts_count)}</div>
          <div className="text-sm text-blue-700 font-medium break-words">Posts</div>
        </div>
        
        <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl">
          <div className="text-3xl font-bold text-green-600 mb-1 truncate">{formatNumber(stats.followers_count)}</div>
          <div className="text-sm text-green-700 font-medium break-words">Followers</div>
        </div>

        <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl">
          <div className="text-3xl font-bold text-purple-600 mb-1 truncate">{formatNumber(stats.following_count)}</div>
          <div className="text-sm text-purple-700 font-medium break-words">Following</div>
        </div>

        <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl">
          <div className="text-3xl font-bold text-orange-600 mb-1 truncate">{stats.streak_days}</div>
          <div className="text-sm text-orange-700 font-medium break-words">Day Streak</div>
        </div>
      </div>
